...
(function (Game) {
    ...
    async function init() {
        ...
        Game.cmpAudioImpact = new ƒ.ComponentAudio(Game.audioImpact, false, false);
        Game.cmpAudioImpact.volume = Game.sfxVolume;
        Game.player.getChild(0).addComponent(new ƒ.ComponentAudioListener());
        Game.player.getChild(0).addComponent(cmpAudioBackground);
        Game.player.getChild(0).addComponent(Game.cmpAudioImpact);
